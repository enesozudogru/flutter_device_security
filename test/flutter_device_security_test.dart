...
void main() {
  ...
  group('FlutterDeviceSecurity', () {
    ...
    group('Android Platform Tests', () {
      ...
      testWidgets('returns AndroidDeviceSecurity for Android platform', (WidgetTester tester) async {
      ...
      testWidgets('AndroidDeviceSecurity contains all Android-specific properties', (WidgetTester tester) async {
        final result = await flutterDeviceSecurity.checkDeviceSecurity();
    ...
    group('iOS Platform Tests', () {
      ...
      testWidgets('returns IOSDeviceSecurity for iOS platform', (WidgetTester tester) async {
        final result = await flutterDeviceSecurity.checkDeviceSecurity();
        ...
        if (result is IOSDeviceSecurity) {
          ...
          expect(() => (result as dynamic).usbDebugging, throwsNoSuchMethodError);
        }
      });
    });

    group('Version Checking', () {
      testWidgets('passes version check with valid minimum version', (WidgetTester tester) async {
      ...
      testWidgets('fails version check with too high minimum version', (WidgetTester tester) async {
        mockPlatform.setMockResponse('checkDeviceVersion', '13.0');

        final result = await flutterDeviceSecurity.checkDeviceSecurity(minimumVersion: '15.0');

        expect(result.version, false);
      });

      testWidgets('handles empty version gracefully', (WidgetTester tester) async {
    ...
    group('Security Features', () {
      testWidgets('detects when passcode is disabled', (WidgetTester tester) async {
      ...
      testWidgets('detects when biometric is unavailable on Android', (WidgetTester tester) async {
      ...
      testWidgets('detects when USB debugging is enabled on Android', (WidgetTester tester) async {
